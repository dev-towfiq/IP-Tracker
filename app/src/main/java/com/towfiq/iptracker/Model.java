...
public class Model {
    ...
    public Model(String ip, String ipDecimal, String country, Boolean countryEu, String countryIso, String city, String hostname, Double latitude, Double longitude, String asn, String asnOrg) {
        super();
        this.ip = ip;
